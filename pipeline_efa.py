"""
pipeline_efa.py  --  BEST: 6 core features, 3 delta pairs, quartimax, 2 factors
======================================================================
quality_score = 0.848  |  stability = 0.791  |  var_explained = 0.841
"""
import sys
import numpy as np
...
from prepare_efa import (load_mouse_level_data, evaluate_stability,
                          evaluate_index_quality, ALL_CANDIDATE_FEATURES,
                          BEHAVIORAL_FEATURES, PUPIL_FEATURES, PHARMA_FEATURES)


def run():
    # ── 1. Feature selection: core addiction-relevant only ────────────
    ...
    # ── 9. Group separation (bonus metric) ───────────────────────────
